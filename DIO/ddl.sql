...
CREATE TABLE Conta_corrente(
	...
	FOREIGN KEY (banco_numero,agencia_numero) REFERENCES Agencia(banco_numero,numero),	-- quando for referenciar um chave prim. de outra tabela, deve-se referenciar todas.
